...
- [ENHANCEMENT] worked around a Firefox bug that caused a missing menu item in the tools menu under certain circumstances, fixes [#339](https://github.com/cadeyrn/newtaboverride/issues/339)
